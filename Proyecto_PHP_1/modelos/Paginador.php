	...
	public function _paginateDetails()
	{
		...
		if($this->_totalRecords > PAGE_LIMIT){
			...
			if($this->_pageNo == 1)	{			
                ...
                $this->_pageLinks .= "<a class=\"pageprevlink\" href=\"" . $this->_currPage ."&page=" . $this->_firstPage . "\">&lt; Inicio</a>";
                $this->_pageLinks .= "<a class=\"pageprevlink\" href=\"" . $this->_currPage ."&page=" . $this->_prevPage . "\">&lt; Anterior</a>";
			}
			...
			if(($this->_totalRecords - (PAGE_LIMIT * $this->_pageNo)) > 0) {
                ...
                $this->_pageLinks .= "<a class=\"pagenextlink\" href=\"" . $this->_currPage . "&page=" . $this->_nextPage . "\">Siguiente &gt;</a>";
                $this->_pageLinks .= "<a class=\"pagenextlink\" href=\"" . $this->_currPage . "&page=" . $this->_lastPage . "\">Final &gt;</a>";
			} else {
