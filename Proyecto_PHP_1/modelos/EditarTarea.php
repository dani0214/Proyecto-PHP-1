...
function updateTarea($post,$id){
    $fecha=formatearFecha($post['fecha_realizar']);
    $conexion = conexion();
    $consulta = "UPDATE tareas SET 
    nombre_tarea='".$post["descripcion"]."',
    persona_contacto='".$post["contacto"]."',
    tlf_contacto='".$post["telefono"]."',
    email='".$post["email"]."',
    poblacion='".$post["poblacion"]."',
    codigo_postal='".$post["cod_postal"]."',
    provincia='".$post["provincia"]."',
    estado='".$post["estado"]."',
    operario_encargado='".$post["operario"]."',
